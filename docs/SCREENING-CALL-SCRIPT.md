...
## Your stats (have these ready)

- Male, **5'9", 162 lb, BMI ~22.5**, ~12–16% body fat
- **Non-smoker**, no nicotine
- Generally healthy; **occasional high cholesterol** (mention only for the cholesterol study — there it's a *qualifier*)
- No current meds / no weight-loss drugs (GLP-1) in the last 3 months
...
3. **"What's the BMI range for this one?"** (confirm 22.5 fits — most floors are 18–18.5)
...
Work top-down by score. As of 2026-08-08 the shortlist to dial:
1. **PPD/Thermo — Austin (877-362-2608)** — in-city, $16,900 / $11,050 healthy studies. Zero travel.
2. **PPD/Thermo — Las Vegas (877-362-2608)** — the **$40,400 MAD** + $19,000. You know people in Vegas → childcare. Ask nights (MAD = weeks).
3. **Fortrea — Dallas (1-866-429-3700)** — $13,707, **3 nights**, 3-hr drive. High velocity.
4. **ICON — SLC 0021-1389** — already applying, $22k, friends cover Riley.
5. **Fortrea — Daytona/Madison** — ~$13k, 2 nights, $100/visit stipend (Madison = WI friend).
6. **JBR/CenExel — SLC (801-261-2000)** — $8,350, SLC childcare (long visit tail — ask to bundle).
7. **ICON — Lenexa 0050/2001** — $11k, your **high-cholesterol qualifier**, drivable once in Omaha.
